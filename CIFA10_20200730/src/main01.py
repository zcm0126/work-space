...
class Train:
    def __init__(self):
        ...
        self.dataset = datasets.CIFAR10("./datasets", train=True, download=True, transform=transform_train)
        self.dataloader = DataLoader(self.dataset, batch_size=512, shuffle=True, drop_last=True)

        # 获取测试数据
        self.test_dataset = datasets.CIFAR10("./datasets", train=False, download=True, transform=transform_train)
